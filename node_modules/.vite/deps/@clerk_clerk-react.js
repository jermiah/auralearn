...
// node_modules/@clerk/shared/dist/runtime/error-D_j0Opgy.mjs
...
// node_modules/@clerk/shared/dist/runtime/keys-Dcilj3cS.mjs
...
// node_modules/@clerk/shared/dist/runtime/telemetry-x9LpQpc1.mjs
...
// node_modules/@clerk/shared/dist/runtime/noop-8bk75rVj.mjs
var noop = (..._args) => {
};

// node_modules/@clerk/shared/dist/runtime/createDeferredPromise-UKTFg5ib.mjs
...
var __experimental_CheckoutProvider = ({ children, ...rest }) => {
  return (0, import_jsx_runtime.jsx)(CheckoutContext.Provider, {
    value: { value: rest },
    children
  });
};
...
var OrganizationProvider = ({ children, organization, swrConfig }) => {
  return (0, import_jsx_runtime.jsx)(SWRConfigCompat, {
    swrConfig,
    children: (0, import_jsx_runtime.jsx)(OrganizationContextInternal.Provider, {
...
var useSessionList = () => {
  ...
  const clerk = useClerkInstanceContext();
  (_a5 = clerk.telemetry) == null ? void 0 : _a5.record(eventMethodCalled(hookName$2));
  if (!client) return {
    isLoaded: false,
    sessions: void 0,
    setActive: void 0
...
function useUser() {
  ...
  const user = useUserContext();
  const clerk = useClerkInstanceContext();
  (_a5 = clerk.telemetry) == null ? void 0 : _a5.record(eventMethodCalled(hookName$1));
...
function createBillingPaginatedHook({ hookName: hookName$4, resourceType, useFetcher, options }) {
  return function useBillingHook(params) {
    ...
    const result = usePagesOrInfinite(hookParams || {}, fetchFn, {
      ...
      type: resourceType,
      ...(options == null ? void 0 : options.unauthenticated) ? { for: safeFor } : {
        userId: user == null ? void 0 : user.id,
...
var useCheckout = (options) => {
  ...
  const properties = (0, import_react6.useMemo)(() => {
...
var Elements = ({ stripe: rawStripeProp, options, children }) => {
  ...
  return (0, import_jsx_runtime.jsx)(ElementsContext.Provider, {
    value: ctx,
    children
  });
};
var useElementsContextWithUseCase = (useCaseMessage) => {
  const ctx = import_react6.default.useContext(ElementsContext);
...
var useElementsOrCheckoutSdkContextWithUseCase = (useCaseString) => {
  const elementsContext = import_react6.default.useContext(ElementsContext);
...
var createElementComponent = (type, isServer$1) => {
  ...
  const ClientElement = ({ id, className, fallback, options = {}, onBlur, onFocus, onReady, onChange, onEscape, onClick, onLoadError, onLoaderStart, onNetworksChange, onConfirm, onCancel, onShippingAddressChange, onShippingRateChange }) => {
    ...
    return (0, import_jsx_runtime.jsxs)(import_jsx_runtime.Fragment, { children: [!isReady && fallback, (0, import_jsx_runtime.jsx)("div", {
      id,
      style: {
...
var StripeLibsProvider = ({ children }) => {
  ...
  return (0, import_jsx_runtime.jsx)(StripeLibsContext.Provider, {
...
var useLocalization = () => {
  ...
  try {
    ...
    locale = (localization == null ? void 0 : localization.locale) || "en";
  } catch {
  }
...
var ValidateStripeUtils = ({ children }) => {
  ...
  return (0, import_jsx_runtime.jsx)(StripeUtilsContext.Provider, {
    value: { value: {
      stripe,
      elements
    } },
...
var PropsProvider = ({ children, ...props }) => {
  ...
  return (0, import_jsx_runtime.jsx)(PaymentElementContext.Provider, {
    value: { value: {
      ...props,
      ...utils,
...
var PaymentElementProvider = ({ children, ...props }) => {
  return (0, import_jsx_runtime.jsx)(StripeLibsProvider, { children: (0, import_jsx_runtime.jsx)(PropsProvider, {
    ...props,
    children: (0, import_jsx_runtime.jsx)(PaymentElementInternalRoot, { children })
  }) });
};
var PaymentElementInternalRoot = (props) => {
  const { stripe, externalClientSecret, stripeAppearance } = usePaymentElementContext();
  const locale = useLocalization();
  if (stripe && externalClientSecret) return (0, import_jsx_runtime.jsx)(Elements, {
    stripe,
    options: {
      loader: "never",
    ...
    children: (0, import_jsx_runtime.jsx)(ValidateStripeUtils, { children: props.children })
  }, externalClientSecret);
  return (0, import_jsx_runtime.jsx)(DummyStripeUtils, { children: props.children });
};
var PaymentElement = ({ fallback }) => {
  ...
  if (!stripe || !externalClientSecret) return (0, import_jsx_runtime.jsx)(import_jsx_runtime.Fragment, { children: fallback });
  return (0, import_jsx_runtime.jsx)(PaymentElement$1, {
    fallback,
    onReady,
    options
  });
...
// node_modules/@clerk/shared/dist/runtime/runtimeEnvironment-aTp6aZUT.mjs
...
// node_modules/@clerk/shared/dist/runtime/deprecated-CFM4jPRM.mjs
...
// node_modules/@clerk/shared/dist/runtime/handleValueOrFn-C3bdLKGZ.mjs
...
// node_modules/@clerk/shared/dist/runtime/utils-DFvkL3Ii.mjs
var logErrorInDevMode = (message) => {
  if (isDevelopmentEnvironment()) console.error(`Clerk: ${message}`);
};

// node_modules/@clerk/clerk-react/dist/chunk-PMUWSU3X.mjs
...
// node_modules/@clerk/shared/dist/runtime/loadScript-Bll0Ohcb.mjs
...
// node_modules/@clerk/shared/dist/runtime/url-BuzaT2V9.mjs
...
// node_modules/@clerk/shared/dist/runtime/versionSelector-Dj9SG9FE.mjs
var versionSelector = (clerkJSVersion, packageVersion = "5.108.0") => {
...
// node_modules/@clerk/shared/dist/runtime/loadClerkJsScript-WietFriT.mjs
...
// node_modules/@clerk/shared/dist/runtime/deriveState-BwW5Y_o5.mjs
...
// node_modules/@clerk/shared/dist/runtime/browser-hvvxjQRr.mjs
function inBrowser() {
...
// node_modules/@clerk/shared/dist/runtime/eventBus-BcGgxxPn.mjs
